          ...
          Padding(
            ...
            child: IconButton(
              onPressed: () => Navigator.push(context,
                  MaterialPageRoute(builder: (_) => const CartPageWeb())),
              icon: Icon(
...
class WebSliverAppBar extends StatelessWidget {
  const WebSliverAppBar({super.key});
  ...
  Widget build(BuildContext context) {
    return SliverAppBar(
      ...
      backgroundColor: context.appBarGreen,
